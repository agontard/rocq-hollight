...
Inductive retval : Type := TT | FF | Exception.
...
Definition istriv_HOL : (seq (prod nat term)) -> nat -> term -> retval := @ε ((prod nat (prod nat (prod nat (prod nat (prod nat nat))))) -> (seq (prod nat term)) -> nat -> term -> retval) (fun istriv' : (prod nat (prod nat (prod nat (prod nat (prod nat nat))))) -> (seq (prod nat term)) -> nat -> term -> retval => forall _262675 : prod nat (prod nat (prod nat (prod nat (prod nat nat)))), forall env : seq (prod nat term), forall x : nat, ((LOOPFREE env) /\ (CONFLICTFREE env)) -> forall t : term, (istriv' _262675 env x t) = (@COND retval (t = (V x)) TT (@COND retval (exists y : nat, (t = (V y)) /\ (@MEM nat y (@map (prod nat term) nat (@fst nat term) env))) (istriv' _262675 env x (@ASSOC nat term (@ε nat (fun y : nat => (t = (V y)) /\ (@MEM nat y (@map (prod nat term) nat (@fst nat term) env)))) env)) (@COND retval (@IN nat x (free_variables_term t)) Exception (@COND retval (exists y : nat, exists s : term, (@IN nat y (free_variables_term t)) /\ ((@MEM (prod nat term) (@pair nat term y s) env) /\ (~ ((istriv' _262675 env x s) = FF)))) Exception FF))))) (@pair nat (prod nat (prod nat (prod nat (prod nat nat)))) (NUMERAL (BIT1 (BIT0 (BIT0 (BIT1 (BIT0 (BIT1 (BIT1 0)))))))) (@pair nat (prod nat (prod nat (prod nat nat))) (NUMERAL (BIT1 (BIT1 (BIT0 (BIT0 (BIT1 (BIT1 (BIT1 0)))))))) (@pair nat (prod nat (prod nat nat)) (NUMERAL (BIT0 (BIT0 (BIT1 (BIT0 (BIT1 (BIT1 (BIT1 0)))))))) (@pair nat (prod nat nat) (NUMERAL (BIT0 (BIT1 (BIT0 (BIT0 (BIT1 (BIT1 (BIT1 0)))))))) (@pair nat nat (NUMERAL (BIT1 (BIT0 (BIT0 (BIT1 (BIT0 (BIT1 (BIT1 0)))))))) (NUMERAL (BIT0 (BIT1 (BIT1 (BIT0 (BIT1 (BIT1 (BIT1 0))))))))))))).
Lemma istriv_def : istriv_HOL = (@ε ((prod nat (prod nat (prod nat (prod nat (prod nat nat))))) -> (seq (prod nat term)) -> nat -> term -> retval) (fun istriv' : (prod nat (prod nat (prod nat (prod nat (prod nat nat))))) -> (seq (prod nat term)) -> nat -> term -> retval => forall _262675 : prod nat (prod nat (prod nat (prod nat (prod nat nat)))), forall env : seq (prod nat term), forall x : nat, ((LOOPFREE env) /\ (CONFLICTFREE env)) -> forall t : term, (istriv' _262675 env x t) = (@COND retval (t = (V x)) TT (@COND retval (exists y : nat, (t = (V y)) /\ (@MEM nat y (@map (prod nat term) nat (@fst nat term) env))) (istriv' _262675 env x (@ASSOC nat term (@ε nat (fun y : nat => (t = (V y)) /\ (@MEM nat y (@map (prod nat term) nat (@fst nat term) env)))) env)) (@COND retval (@IN nat x (free_variables_term t)) Exception (@COND retval (exists y : nat, exists s : term, (@IN nat y (free_variables_term t)) /\ ((@MEM (prod nat term) (@pair nat term y s) env) /\ (~ ((istriv' _262675 env x s) = FF)))) Exception FF))))) (@pair nat (prod nat (prod nat (prod nat (prod nat nat)))) (NUMERAL (BIT1 (BIT0 (BIT0 (BIT1 (BIT0 (BIT1 (BIT1 0)))))))) (@pair nat (prod nat (prod nat (prod nat nat))) (NUMERAL (BIT1 (BIT1 (BIT0 (BIT0 (BIT1 (BIT1 (BIT1 0)))))))) (@pair nat (prod nat (prod nat nat)) (NUMERAL (BIT0 (BIT0 (BIT1 (BIT0 (BIT1 (BIT1 (BIT1 0)))))))) (@pair nat (prod nat nat) (NUMERAL (BIT0 (BIT1 (BIT0 (BIT0 (BIT1 (BIT1 (BIT1 0)))))))) (@pair nat nat (NUMERAL (BIT1 (BIT0 (BIT0 (BIT1 (BIT0 (BIT1 (BIT1 0)))))))) (NUMERAL (BIT0 (BIT1 (BIT1 (BIT0 (BIT1 (BIT1 (BIT1 0)))))))))))))).
Proof. exact erefl. Qed.
...
Definition CRIGHT_HOL c c' := match c,c' with (env', eqs'),(env, eqs) =>
  (LOOPFREE env /\
   env' = env /\
